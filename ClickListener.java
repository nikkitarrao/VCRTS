...
public class ClickListener implements ActionListener {
    ...
    public JPanel createAccount() {
        ...
        createAccountPanel.add(Box.createRigidArea(new Dimension(0, 20)));  // Spacing
        createAccountPanel.add(button1);
        createAccountPanel.add(Box.createRigidArea(new Dimension(0, 30)));  // Spacing
        createAccountPanel.add(button2);
        createAccountPanel.add(Box.createRigidArea(new Dimension(0, 10)));  // Spacing
